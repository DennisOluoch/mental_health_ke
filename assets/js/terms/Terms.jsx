...
const Terms = () => {
  ...
  return (
    <Container maxWidth="md" className={classes.root}>
      ...
      <p>
        Welcome to <b>Valhalla Media Group</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>masenomental.com</b> (together or individually
        “Service”) operated by <b>Valhalla Media Group</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>valhallamediagroup@gmail.com</b> so we can try to find a solution.
      ...
      <p>
        Content found on or through this Service are the property of Valhalla
        Media Group or used with permission. You may not distribute, modify,
      ...
      <p>
        ...
        Valhalla Media Group and its licensors. Service is protected by
        ...
        without the prior written consent of Valhalla Media Group.
      </p>
      <p>
      ...
      <p>
        ...
        to valhallamediagroup@gmail.com, with the subject line: “Copyright
      ...
      <p>
        You may provide us either directly at valhallamediagroup@gmail.com or
      ...
      <p>
        ...
        are not owned or controlled by Valhalla Media Group.
      </p>
      <p>
        Valhalla Media Group has no control over, and assumes no responsibility
      ...
      <p>
        ...
        of Kenya, which governing law applies to agreement without regard to its
      ...
      <p>
        ...
        email: <b>valhallamediagroup@gmail.com</b>.
      </p>
    </Container>
  )
}
